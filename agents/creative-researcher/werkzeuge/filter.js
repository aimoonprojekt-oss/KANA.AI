...
const AUFTRAG = process.env.AUFTRAG_DATEI || '/mnt/memory/kana-wissen/auftrag.json'
...
const out = arg('--out')
const BEKANNT = process.env.BEKANNTE_DATEI || '/mnt/memory/kana-wissen/bekannte-ads.json'
