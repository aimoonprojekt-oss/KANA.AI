      ...
      <div className="admin-karte__zeile">
        ...
        <div className="admin-feld" style={{ flex: "1 1 220px", minWidth: 200 }}>
          <div className="admin-name">
            ...
            {/* Master oder Kundenkopie. Seit die Kopien exakt wie ihr Master
                heissen — dieselben sechs Namen in jedem Kundenworkspace —
                ist der Name allein nicht mehr unterscheidend. */}
            <span className={`badge ${agent.master_agent_id ? "badge-outline" : "badge-solid"}`}>
          ...
          <div className="mono-num admin-kennung" title="Environment, in dem dieser Agent laeuft">
