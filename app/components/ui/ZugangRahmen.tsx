...
const TEXTE: Record<Modus, {
  ...
  anmelden: {
    ...
    pitchText: "Läufe, Ergebnisse und Dateien liegen dort, wo du sie zuletzt gelassen hast.",
    punkte: [
      ...
      "Support über die Blase im Portal",
    ],
  },
  registrieren: {
    headline: "Arbeitsbereich anlegen",
    sub: "Nach der Registrierung wählst du deine erste Abteilung und buchst den ersten Agent.",
    pitchTitle: "In wenigen Tagen arbeitet der erste Agent.",
    pitchText: "Onboarding-Gespräch, Einrichtung, erste Ergebnisse — ohne Agentur, ohne eigenes Team.",
    punkte: [
      "Monatlich kündbar, kein Jahresvertrag",
      "Setup nach dem Gespräch in 3–5 Tagen",
      "Ein Agent reicht zum Anfangen",
