    ...
    <div className="chat">
      ...
      <main className="chat-main">
        ...
        <div className="chat-messages">
          ...
          {/* ── Erzeugte Dateien ──
              Der Link kommt fertig signiert von /api/chat und zeigt direkt in
              den privaten Storage-Bucket. Der fruehere Weg ueber
              /api/files/<id>?session=... traegt nicht mehr: die Datei wird
              nach der Uebernahme aus der Files API geloescht, dort waere also
              nichts mehr zu holen. Die Zugriffspruefung sitzt jetzt in der
              Signatur — der Link laeuft nach einer Stunde ab.
              Eintraege ohne URL werden ausgelassen statt als toter Link
              angeboten. */}
          {outputFiles.some((f) => f.url) && (
